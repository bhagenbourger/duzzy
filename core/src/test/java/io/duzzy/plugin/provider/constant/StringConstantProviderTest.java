...
public class StringConstantProviderTest {
    ...
    void computeValueIsIdempotent() {
        final String value = new StringConstantProvider("myValue").value(SEEDED_ONE_COLUMN_CONTEXT.get());
        assertThat(value).isEqualTo("myValue");
    }

    @Test
    void computeValueIsConstant() {
        final String value = new StringConstantProvider("myValue").value(SEEDED_FIVE_COLUMN_CONTEXT.get());
        assertThat(value).isEqualTo("myValue");
    }

    @Test
    void corruptedValueIsIdempotent() {
        final String value = new StringConstantProvider("myValue").corruptedValue(SEEDED_ONE_COLUMN_CONTEXT.get());
