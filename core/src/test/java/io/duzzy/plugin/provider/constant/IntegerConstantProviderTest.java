...
public class IntegerConstantProviderTest {
  ...
  void computeValueIsIdempotent() {
    final Integer value = new IntegerConstantProvider(3).value(SEEDED_ONE_FIELD_CONTEXT.get());
    assertThat(value).isEqualTo(3);
  }

  @Test
  void computeValueIsConstant() {
    final Integer value = new IntegerConstantProvider(3).value(SEEDED_FIVE_FIELD_CONTEXT.get());
    assertThat(value).isEqualTo(3);
  }
  ...
  void corruptedValueIsIdempotent() {
    final Integer value =
        new IntegerConstantProvider(3).corruptedValue(SEEDED_ONE_FIELD_CONTEXT.get());
