...
public class AzureBlobStorageSinkTest {
  ...
  public void testSink() throws Exception {
    ...
    final AzureBlobStorageSink sink = new MockAzureBlobStorageSink(
        new JsonSerializer(),
        "devstoreaccount1",
        true,
        containerName,
  ...
  private static class MockAzureBlobStorageSink extends AzureBlobStorageSink {

    public MockAzureBlobStorageSink(
    ...
    public Sink fork(Long threadId) throws Exception {
      return new MockAzureBlobStorageSink(
